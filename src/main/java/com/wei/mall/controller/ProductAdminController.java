...
import com.wei.mall.model.request.UpdateProductReq;
    ...
    public ApiRestResponse upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) {
        ...
        if (!fileDirectory.exists()) {
            if (!fileDirectory.mkdir()) {
                throw new WeiMallException(WeiMallExceptionEnum.MKDIR_FAILED);
            }
        }
        try {
        ...
        try {
            ...
            return ApiRestResponse.error(WeiMallExceptionEnum.UPLOAD_FAILED);
        }
    }
