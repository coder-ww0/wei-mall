...
# Dump of table wei_mall_category
# ------------------------------------------------------------
...
LOCK TABLES `wei_mall_category` WRITE;
/*!40000 ALTER TABLE `wei_mall_category` DISABLE KEYS */;

INSERT INTO `wei_mall_category` (`id`, `name`, `type`, `parent_id`, `order_num`, `create_time`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `wei_mall_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wei_mall_order
# ------------------------------------------------------------
...
# Dump of table wei_mall_order_item
# ------------------------------------------------------------
...
# Dump of table wei_mall_product
# ------------------------------------------------------------
...
LOCK TABLES `wei_mall_product` WRITE;
/*!40000 ALTER TABLE `wei_mall_product` DISABLE KEYS */;

INSERT INTO `wei_mall_product` (`id`, `name`, `image`, `detail`, `category_id`, `price`, `stock`, `status`, `create_time`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `wei_mall_product` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wei_mall_user
# ------------------------------------------------------------
...
LOCK TABLES `wei_mall_user` WRITE;
/*!40000 ALTER TABLE `wei_mall_user` DISABLE KEYS */;

INSERT INTO `wei_mall_user` (`id`, `username`, `password`, `personalized_signature`, `role`, `create_time`, `update_time`)
VALUES
	...
	(14,'wei','SMRMN9k6YmXAjbsJCMdxrQ==','',1,'2020-03-02 22:45:48','2020-03-02 22:45:48'),
	(15,'super2','SMRMN9k6YmXAjbsJCMdxrQ==','',1,'2020-03-07 18:09:47','2020-03-07 18:09:47');

/*!40000 ALTER TABLE `wei_mall_user` ENABLE KEYS */;
UNLOCK TABLES;
